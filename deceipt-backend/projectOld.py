...
def process_receipt(filename):
    ...
    scanned = crop_and_rotate(status, original, image, receipt_contour, resize_ratio)
    colour_transform(scanned, original, filename)

    json_object = extract_data(filename)
    return json_object

print(process_receipt("test.png"))
print(process_receipt("test2.jpeg"))
print(process_receipt("test3.jpg"))
print(process_receipt("test4.jpg"))
print(process_receipt("test5.JPG"))
print(process_receipt("test6.png"))
